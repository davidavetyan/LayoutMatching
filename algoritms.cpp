...
bool isBipartite(std::vector<std::vector<int>> const& G, std::pair<std::vector<int>, std::vector<int>>& bipartitionIndexes)
{
...
void createAdjFromBipartition(std::vector<std::vector<int>> const& G, std::pair<std::vector<int>, std::vector<int>> const& bipartitionIndexes, std::vector<std::vector<int>>& adjMatrix)
{
	int V = G.size();
...
namespace Hungarian
{
	...
	void step2(const std::vector<std::vector<int>>& matrix,
	...
	void step4(const std::vector<std::vector<int>>& matrix,
		std::vector<std::vector<int>>& M,
		std::vector<int>& RowCover,
		std::vector<int>& ColCover,
		int& path_row_0,
	...
	void solveHungarian(const std::vector<std::vector<int>>& original, std::vector<std::vector<int>>& M, bool allow_negatives, bool maximize)
	{
	...
	void getEdgesFromHungarian(std::vector<std::vector<int>> const& adjMatrix,
		...
		std::vector<std::vector<int>> const& hungarianMask, std::vector<std::pair<int, int>>& edges)
	{
		edges.clear();
