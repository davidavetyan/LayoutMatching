...
public:
    ...
    InformationDialog(QTableWidget* table) : tbl(table)
    {
    ...
    void setTableItem(QTableWidgetItem* it, int column, int raw) { tbl->setItem(column, raw, it); }
...
public:
    FloydHelp(QTableWidget* table) : tbl(table)
    {
