...
#include "node.h"
#include <math.h>
MGraphView::MGraphView(QWidget* parent) : QGraphicsView(parent)
{
...
void MGraphView::dragMoveEvent(QDragMoveEvent* event)
{
    Q_UNUSED(event)
}

void MGraphView::dragLeaveEvent(QDragLeaveEvent* event)
{
    Q_UNUSED(event);
}
